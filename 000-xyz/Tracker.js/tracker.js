    ...
    if (g.trackJs) 
        ...
        p.prototype = {
            watch: function () {
                d
                    .forEach([
                        ...
                        d.has(g, a + ".prototype.addEventListener") && d.hasOwn(g[a].prototype, "addEventListener") && this.wrapEventTarget(g[a].prototype)
                    }, this);
            ...
            wrap: function (a) {
                ...
                var c = this;
                try {
                    if (!d.isFunction(a) || d.hasOwn(a, "__trackjs__")) 
                        return a;
                    if (d.hasOwn(a, "__trackjs_state__")) 
            ...
            wrapEventTarget: function (a) {
                var b = this;
                d.has(a, "addEventListener.call") && d.has(a, "removeEventListener.call") && (d.patch(a, "addEventListener", function (a) {
                    return function (e, f, h, m) {
                        try {
                            d.has(f, "handleEvent") && (f.handleEvent = b.wrap(f.handleEvent))
                        } catch (k) {}
                        return a.call(this, e, b.wrap(f), h, m)
                    }
                }), d.patch(a, "removeEventListener", function (a) {
                    return function (b, f, h, d) {
                        try {
                            f = f && (f.__trackjs_state__ || f)
                        } catch (k) {}
                        return a.call(this, b, f, h, d)
                    }
                }))
            },
            wrapTimer: function (a) {
                var b = this;
                d.patch(g, a, function (a) {
                    return function (e, f) {
                        var h = Array
                                .prototype
                                .slice
                                .call(arguments),
                            m = h[0];
                        d.isFunction(m) && (h[0] = b.wrap(m));
                        return d.has(a, "apply")
                            ? a.apply(this, h)
                            : a(h[0], h[1])
                    }
                })
        ...
        t.prototype = {
            ...
            defaults: {
                ...
                serialize: function (a) {
                    ...
                    if (a === l) 
                        return "undefined";
                    if (d.isString(a) || d.isNumber(a) || d.isBoolean(a) || d.isFunction(a)) 
                        return "" + a;
                    if (d.isElement(a)) 
                        return b(a);
                    var c;
            ...
            initCurrent: function (a) {
                if (this.validate(a, this.defaults, "config", {})) 
                    return this.current = d.defaultsDeep({}, a, this.defaults),
                    !0;
                this.current = d.defaultsDeep({}, this.defaults);
                console.log("init current config", this.current);
                return !1
            },
            setCurrent: function (a) {
                return this.validate(a, this.defaults, "config", this.initOnly)
                    ? (this.current = d.defaultsDeep({}, a, this.current), !0)
                    : !1
            },
            validate: function (a, b, c, e) {
                var f = !0;
                c = c || "";
                e = e || {};
                for (var h in a) 
                    if (a.hasOwnProperty(h)) 
                        if (b.hasOwnProperty(h)) {
                            var d = typeof b[h];
                            d !== typeof a[h]
                                ? (console.warn(c + "." + h + ": property must be type " + d + "."), f = !1)
                                : "[object Array]" !== Object
                                    .prototype
                                    .toString
                                    .call(a[h]) || this.validateArray(a[h], b[h], c + "." + h)
                                    ? "[object Object]" === Object
                                        .prototype
                                        .toString
                                        .call(a[h])
                                        ? f = this.validate(a[h], b[h], c + "." + h, e[h])
                                        : e.hasOwnProperty(h) && (console.warn(c + "." + h + ": property cannot be set after load."), f = !1)
                                    : f = !1
                        }
                    else 
                    console.warn(c + "." + h + ": property not supported."),
                    f = !1;
                return f
            },
            validateArray: function (a, b, c) {
                ...
                for (var f = 0; f < a.length; f++) 
                    d.contains(b, a[f]) || (console.warn(c + "[" + f + "]: invalid value: " + a[f] + "."), e = !1);
                return e
            }
        };
        var u = function (a, b, c, e, f, h, d) {
            this.util = a;
            this.log = b;
            this.onError = c;
            this.onFault = e;
            this.serialize = f;
            d.enabled && (h.console = this.wrapConsoleObject(h.console, d))
        };
        u.prototype = {
                                ...
                                e
                                    ...
                                    .add("c", {
                                        timestamp: e
                                            ...
                                            .isoNow(),
                                        severity: f,
                                        message: e.serialize(1 === a.length
                                            ? a[0]
                                            : a)
                                    });
                                if (b[f]) 
                                    if (d.isError(a[0]) && 1 === a.length) 
                                        e.onError("console", a[0]);
                                    else 
                                        try {
                                            throw Error(e.serialize(1 === a.length
                                                ? a[0]
                                                : a));
                                        } catch (c) {
                                            e.onError("console", c)
                                        }
                                    b.display && (e.util.hasFunction(m, "apply")
                                    ? m.apply(this, a)
                                    : m(a[0]))
                            } catch (c) {
                                e.onFault(c)
            ...
            getCorrelationId: function () {
                ...
                try {
                    a = this
                        .document
                        .cookie
                        .replace(/(?:(?:^|.*;\s*)TrackJS\s*\=\s*([^;]*).*$)|^.*$/, "$1"),
                    a || (a = this.util.uuid(), this.document.cookie = "TrackJS=" + a + "; expires=Fri, 31 Dec 9999 23:59:59 GMT; path=/")
                } catch (b) {
                    a = this
                        .util
                        .uuid()
        ...
        var w = function () {
            ...
            this.originalUrl = d.getLocation();
            ...
            discoverDependencies: function () {
                ...
                for (var b in g) 
                    if ("_trackJs" !== b && "_trackJS" !== b && "_trackjs" !== b && "webkitStorageInfo" !== b && "webkitIndexedDB" !== b && "top" !== b && "parent" !== b && "frameElement" !== b) 
                        try {
                            if (g[b]) {
                                var c = g[b].version || g[b].Version || g[b].VERSION;
        ...
        y.prototype = {
            all: function (a) {
                ...
                for (e = 0; e < this.appender.length; e++) 
                    (c = this.appender[e]) && c.category === a && b.push(c.value);
                return b
            },
            clear: function () {
            ...
            get: function (a, b) {
                var c,
                    e;
                for (e = 0; e < this.appender.length; e++) 
                    if (c = this.appender[e], c.category === a && c.key === b) 
                        return c.value;
            return !1
            }
        };
        ...
        z.prototype = {
            isCompatible: function (a) {
                a = a || g;
                return !d.has(a, "chrome.app.runtime") && d.has(a, "addEventListener") && d.has(a, "history.pushState")
            },
        ...
        var A = function (a, b, c, e, f, d) {
            ...
            this.window = f;
            this.options = d;
            d.enabled && this.initialize(f)
        };
        A.prototype = {
            initialize: function (a) {
                a.XMLHttpRequest && this
                    .util
                    .hasFunction(a.XMLHttpRequest.prototype.open, "apply") && this.watchNetworkObject(a.XMLHttpRequest);
                a.XDomainRequest && this
                    .util
                    .hasFunction(a.XDomainRequest.prototype.open, "apply") && this.watchNetworkObject(a.XDomainRequest);
                this.options.fetch && d.isWrappableFunction(a.fetch) && this.watchFetch()
            },
            watchFetch: function () {
                var a = this.log,
                    b = this.options,
                    c = this.onError;
                d.patch(g, "fetch", function (e) {
                    return function (f, h) {
                        var m = f instanceof Request
                                ? f
                                : new Request(f, h),
                            k = e.apply(g, arguments);
                        k.__trackjs_state__ = a.add("n", {
                            type: "fetch",
                            startedOn: d.isoNow(),
                            method: m.method,
                            url: m.url
                        ...
                        return k.then(function (e) {
                            var f = a.get("n", k.__trackjs_state__);
                            f && (d.defaults(f, {
                                completedOn: d.isoNow(),
                                statusCode: e.status,
                                statusText: e.statusText
                            }), b.error && 400 <= e.status && c("ajax", f.statusCode + " " + f.statusText + ": " + f.method + " " + f.url));
                            return e
                        })["catch"](function (e) {
                            var f = a.get("n", k.__trackjs_state__);
                            f && (d.defaults(f, {
            ...
            watchNetworkObject: function (a) {
                ...
                a.prototype.open = function (a, b) {
                    var e = (b || "").toString();
                    0 > e.indexOf("localhost:0") && (this._trackJs = {
                        method: a,
                        url: e
                    });
                    ...
                    : setTimeout(function () {
                        try {
                            ...
                            a.onload = function () {
                                ...
                                "function" === typeof c && b
                                    .util
                                    .hasFunction(c, "apply") && c.apply(a, arguments)
                            };
                            var e = a.onerror;
                            a.onerror = function () {
                                b.finalizeNetworkEvent(a);
            ...
            finalizeNetworkEvent: function (a) {
                if (a._trackJs) {
                    var b = this
                        .log
                        .get("n", a._trackJs.logId);
                    b && (b.completedOn = this.util.isoNow(), b.statusCode = 1223 == a.status
                        ? 204
                        : a.status, b.statusText = 1223 == a.status
                        ? "No Content"
                        : a.statusText)
                }
            },
        ...
        q.prototype = {
            errorEndpoint: function (a) {
                ...
                this
                    .util
                    .testCrossdomainXhr() || -1 !== g
                    .location
                    .protocol
                    .indexOf("https") || (b = this.config.current.errorNoSSLURL);
                return b + "?token=" + a
            },
            ...
            getCORSRequest: function (a, b) {
                ...
                this
                    .util
                    .testCrossdomainXhr()
                    ? (c = new g.XMLHttpRequest, c.open(a, b), c.setRequestHeader("Content-Type", "text/plain"))
                    : "undefined" !== typeof g.XDomainRequest
                        ? (c = new g.XDomainRequest, c.open(a, b))
                        : c = null;
                return c
            },
                ...
                if (!this.disabled && !this.throttle(a)) 
                    try {
                        ...
                        e.onreadystatechange = function () {
                            4 === e.readyState && 200 !== e.status && (c.disabled = !0)
                        };
                        e._trackJs = l;
        ...
        var d = function () {
                function a(c, e, f, h) {
                    ...
                    d.forEach(e, function (e) {
                        d
                            .forEach(d.keys(e), function (d) {
                                null === e[d] || e[d] === l
                                    ? c[d] = e[d]
                                    : f && 10 > h && "[object Object]" === b(e[d])
                                        ? (c[d] = c[d] || {}, a(c[d], [e[d]], f, h + 1))
                                        : c.hasOwnProperty(d) || (c[d] = e[d])
                            })
                    });
                    return c
                }
                ...
                return {
                    addEventListenerSafe: function (a, b, f, d) {
                        a.addEventListener
                    ...
                    afterDocumentLoad: function (a) {
                        ...
                        "complete" === n.readyState
                            ? d.defer(a)
                            : (d.addEventListenerSafe(n, "readystatechange", function () {
                                "complete" !== n.readyState || b || (d.defer(a), b = !0)
                            }), setTimeout(function () {
                                b || (d.defer(a), b = !0)
                            }, 1E4))
                    },
                    ...
                    getLocationURL: function () {
                        return d.parseURL(d.getLocation())
                    },
                    has: function (a, b) {
                        try {
                            for (var f = b.split("."), d = a, g = 0; g < f.length; g++) 
                                if (d[f[g]]) 
                                    d = d[f[g]];
                                else 
                                    return !1;
                    ...
                    isBoolean: function (a) {
                        return "boolean" === typeof a || d.isObject(a) && "[object Boolean]" === b(a)
                    },
                    ...
                    isError: function (a) {
                        if (!d.isObject(a)) 
                            return !1;
                        var e = b(a);
                        return "[object Error]" === e || "[object DOMException]" === e || d.isString(a.name) && d.isString(a.message)
                    },
                    isElement: function (a) {
                        return d.isObject(a) && 1 === a.nodeType
                    },
                    isFunction: function (a) {
                        return !(!a || "function" !== typeof a)
                    },
                    isNumber: function (a) {
                        return "number" === typeof a || d.isObject(a) && "[object Number]" === b(a)
                    },
                    isObject: function (a) {
                        return !(!a || "object" !== typeof a)
                    },
                    isString: function (a) {
                        return "string" === typeof a || !d.isArray(a) && d.isObject(a) && "[object String]" === b(a)
                    },
                    ...
                    isoNow: function () {
                        ...
                        return a.toISOString
                            ? a.toISOString()
                            : a.getUTCFullYear() + "-" + this.pad(a.getUTCMonth() + 1) + "-" + this.pad(a.getUTCDate()) + "T" + this.pad(a.getUTCHours()) + ":" + this.pad(a.getUTCMinutes()) + ":" + this.pad(a.getUTCSeconds()) + "." + String((a.getUTCMilliseconds() / 1E3).toFixed(3)).slice(2, 5) + "Z"
                    },
                    keys: function (a) {
                        if (!d.isObject(a)) 
                            return [];
        ...
        B.prototype = {
            initialize: function (a) {
                var b = this
                        .util
                        .bind(this.onDocumentClicked, this),
                    c = this
                        .util
                        .bind(this.onInputChanged, this);
                a.addEventListener
                    ? (a.addEventListener("click", b, !0), a.addEventListener("blur", c, !0))
                    : a.attachEvent && (a.attachEvent("onclick", b), a.attachEvent("onfocusout", c))
            },
            onDocumentClicked: function (a) {
                try {
                    var b = this.getElementFromEvent(a);
                    b && b.tagName && (this.isDescribedElement(b, "a") || this.isDescribedElement(b, "button") || this.isDescribedElement(b, "input", ["button", "submit"])
            ...
            writeVisitorEvent: function (a, b, c, e) {
                "password" === this.getElementType(a) && (c = l);
                this
                    .log
                    .add("v", {
                        timestamp: this
        ...
        var C = function (a, b, c, e, f) {
            this.onError = a;
            this.onFault = b;
            this.serialize = c;
            f.enabled && this.watchWindowErrors(e);
            f.promise && this.watchPromiseErrors(e)
        };
        C.prototype = {
            ...
            watchWindowErrors: function (a) {
                var b = this;
                d.patch(a, "onerror", function (a) {
                    return function (e, f, d, g, k) {
                        try {
                            k = k || {},
                            k.message = k.message || b.serialize(e),
                            k.name = k.name || "Error",
                            k.line = k.line || parseInt(d, 10) || null,
                            k.column = k.column || parseInt(g, 10) || null,
                            "[object Event]" !== Object
                                .prototype
                                .toString
                                .call(e) || f
                                ? k.file = k.file || b.serialize(f)
                                : k.file = (e.target || {}).src,
                            b.onError("window", k)
                        } catch (x) {
                            b.onFault(x)
        ...
        var D = function (a, b, c, e, f, h, g, k, x, l, n, p, q, t, u, v) {
            try {
                if (this.window = t, this.document = u, this.util = d, this.onError = this.util.bind(this.onError, this), this.onFault = this.util.bind(this.onFault, this), this.serialize = this.util.bind(this.serialize, this), this.config = new e(a), this.transmitter = new n(this.util, this.config), this.log = new k(this.util), this.api = new b(this.config, this.util, this.onError, this.serialize), this.metadata = new x(this.serialize), this.environment = new g, this.customer = new h(this.config, this.util, this.log, this.window, this.document), this.customer.token && (this.apiConsoleWatcher = new f(this.util, this.log, this.onError, this.onFault, this.serialize, this.api, this.config.defaults.console), this.config.current.enabled && (this.windowConsoleWatcher = new f(this.util, this.log, this.onError, this.onFault, this.serialize, this.window, this.config.current.console), this.util.isBrowserSupported()))) {
                    ...
                    this.networkWatcher = new l(this.util, this.log, this.onError, this.onFault, this.window, this.config.current.network);
                    this.windowWatcher = new q(this.onError, this.onFault, this.serialize, this.window, this.config.current.window);
                    var r = this;
                    d.afterDocumentLoad(function () {
                        r
                            .transmitter
                            .sendUsage({
        ...
        D.prototype = {
            reveal: function () {
                if (this.customer.token) 
                    ...
                    this.api;
                this.config.current.enabled && this.window.console && this.window.console.warn && this
                    .window
                    .console
                    .warn("TrackJS could not find a token");
                return l
            },
            onError: function () {
                var a,
                ...
                return function (c, e, f) {
                    if (d.isBrowserSupported() && this.config.current.enabled) 
                        try {
                            if (f = f || {
                                bindStack: null,
                                bindTime: null,
                                ...
                                name: "Error",
                                message: this.serialize(e, f.force)
                            }), -1 === e.message.indexOf("TrackJS Caught")) 
                                if (b && -1 !== e.message.indexOf("Script error")) 
                                    b = !1;
                                else {
                                    var h = d.defaultsDeep({}, {
                                    ...
                                    if (!f.force) 
                                        try {
                                            if (!this.config.current.onError(h, e)) 
                                                return
                                        } catch (l) {
                                            h
                                                .console
                                    ...
                                    this
                                        .transmitter
                                        .sendError(h, this.customer.token)
                                }
                            } catch (l) {
                            this.onFault(l)
                        }
        ...
        p = new D(g._trackJs || g._trackJS || g._trackjs || {}, function (a, b, c, e) {
            return {
                attempt: function (a, e) {
                    try {
                        var d = Array
                            .prototype
                            .slice
                            .call(arguments, 2);
                        return a.apply(e || this, d)
                    } catch (g) {
                        throw c("catch", g),
                        b.wrapError(g);
                    }
